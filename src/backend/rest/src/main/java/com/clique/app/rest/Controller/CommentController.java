...
import com.clique.app.rest.Models.Response.CommentResponseDto;
...
import com.clique.app.rest.Service.CommentService;
...
public class CommentController {
    ...
    @PostMapping("/{postId}")
    public ResponseEntity<Comment> comment(@PathVariable Long postId, @RequestParam Long userId, @RequestParam String content) {
    ...
    public ResponseEntity<List<CommentResponseDto>> getCommentsByPostId(@PathVariable Long postId) {
        ...
        List<CommentResponseDto> response = comments.stream().map(comment -> {
            ...
            return new CommentResponseDto(username, comment.getContent(), comment.getCreatedAt());
        }).toList();
