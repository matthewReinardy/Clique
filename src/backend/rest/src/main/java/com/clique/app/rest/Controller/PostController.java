...
import com.clique.app.rest.Models.Response.PostDto;
import com.clique.app.rest.Models.User;
import com.clique.app.rest.Models.utils.DateTimeUtils;
...
public class PostController {
    ...
    public Post createPost(@PathVariable Long userId, @ModelAttribute PostCreateRequest postRequest) throws IOException {
        ...
        int currentPostCount = author.getPostCount() != null ? author.getPostCount() : 0;
        author.setPostCount(currentPostCount + 1);
        userRepository.save(author); // Save updated user
 ...
 public ResponseEntity<List<PostDto>> getPostsByUserId(@PathVariable Long userId) {
     ...
     List<PostDto> dtoList=new ArrayList<>();
         ...
         dto.setMediaFileName(post.getMediaFileName());
         dto.setMediaFileData(post.getMediaFileData());
         dto.setCreatedAt(DateTimeUtils.formatLocalDateTime(post.getCreatedAt()));
    ...
    public ResponseEntity<String> deletePost(@PathVariable Long userId, @PathVariable Long postId) {
        ...
        int currentPostCount = author.getPostCount() != null ? author.getPostCount() : 0;
        author.setPostCount(Math.max(0, currentPostCount - 1));
        userRepository.save(author); // Update post count
